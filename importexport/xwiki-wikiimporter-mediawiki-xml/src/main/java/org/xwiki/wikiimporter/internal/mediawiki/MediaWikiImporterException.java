...
/**
 * Encapsulate MediaWiki Importer errors.
 * 
 * @version $Id$
 */
public class MediaWikiImporterException extends WikiImporterException
{
     ...
     */
    public MediaWikiImporterException(String message)
    {
        super(message);
    }
     ...
     */
    public MediaWikiImporterException(String message, Throwable throwable)
    {
