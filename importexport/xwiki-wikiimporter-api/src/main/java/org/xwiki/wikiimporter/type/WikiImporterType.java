 ...
 * @version $Id$
 */
public class WikiImporterType
{

    public static final WikiImporterType MEDIAWIKI_XML = new WikiImporterType(WikiType.MEDIAWIKI, "XML");
     ...
     */
    public WikiImporterType(WikiType type, String dataFormat)
    {
        this.type = type;
    ...
    public boolean equals(Object object)
    {
        ...
        if (this == object) {
            ...
            if ((object == null) || (object.getClass() != this.getClass())) {
                ...
                WikiImporterType type = (WikiImporterType) object;
