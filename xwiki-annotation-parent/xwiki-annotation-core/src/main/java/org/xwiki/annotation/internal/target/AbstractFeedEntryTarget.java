...
/**
 * This class factors logic for adding an annotation to a feedentry in XWiki Watch.
 * 
 * @version $Id$
 */
public abstract class AbstractFeedEntryTarget extends AbstractAnnotationTarget
{
    /**
     * {@inheritDoc}
     * 
