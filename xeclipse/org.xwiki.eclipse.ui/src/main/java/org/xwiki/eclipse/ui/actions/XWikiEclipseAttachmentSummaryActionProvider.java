...
public class XWikiEclipseAttachmentSummaryActionProvider extends CommonActionProvider
{
    private Action open;

    private CommandContributionItem renameAttachment;
    ...
    public void fillContextMenu(IMenuManager menu)
    {
        ...
        menu.appendToGroup(ICommonMenuConstants.GROUP_ADDITIONS, renameAttachment);
    }
