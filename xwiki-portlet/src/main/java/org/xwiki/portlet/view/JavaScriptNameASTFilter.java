...
public class JavaScriptNameASTFilter implements NodeVisitor
{
    ...
    private static final List<String> PREDEFINED_NAMES =
        Arrays.asList("Boolean", "Number", "String", "Array", "Object", "Function", "RegExp", "Date", "JSON", "Error",
            ...
            "Element", "HTMLElement", "Document", "Window", "Event", "Selection", "Range", "Image", "XPathResult",
            "XMLHttpRequest", "DOMParser", "ActiveXObject", "self", "console", "alert", "confirm", "setTimeout",
            "clearTimeout", "setInterval", "clearInterval", "unescape", "location",
             ...
             * transformed by this filter because it is inserted dynamically in the document head. */
            "xwe", "WysiwygEditor", "CommandManager");
