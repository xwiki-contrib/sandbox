...
public class ExtensionInstallerException extends ExtensionException
{
    /**
     ...
     */
    public ExtensionInstallerException(String message)
    {
        super(message);
    }
     ...
     */
    public ExtensionInstallerException(String message, Throwable cause)
    {
        super(message, cause);
    }
}
