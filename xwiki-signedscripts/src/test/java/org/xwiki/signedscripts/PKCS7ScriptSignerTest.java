...
public class PKCS7ScriptSignerTest extends AbstractSignedScriptsTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        getMockery().checking(new Expectations() {{
            allowing(mockCrypto).signText(with(any(String.class)), with(getTestKeyPair()), with("pass"));
                will(returnValue("signed text"));
        }});
    }
    ...
    public void testSign() throws GeneralSecurityException
    {
        ...
        SignedScript script = signer.sign(code, getTestKeyPair().getFingerprint(), "pass");
