...
public class DefaultXWikiX509KeyPairTest extends AbstractComponentTestCase
{
    ...
    public void testExportImport() throws Exception
    {
        ...
        X509Certificate cert = keyMaker.makeClientCertificate(kp.getPublic(),
                                                              kp,
                                                              1,
                                                              true,
                                                              "http://my.web.id.com/",
                                                              "xwiki:XWiki.Me");
        XWikiX509KeyPair keyPair = new DefaultXWikiX509KeyPair(cert, kp.getPrivate(), password, this.service);
        byte[] exported = keyPair.serialize();
        XWikiX509KeyPair imported = (XWikiX509KeyPair) SerializationUtils.deserialize(exported);
