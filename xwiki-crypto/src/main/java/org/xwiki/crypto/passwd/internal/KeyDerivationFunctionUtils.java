...
/**
 * Utilities for getting the default key derivation function and for serialization and deserialization of functions.
 *
 * @since 2.5
 * @version $Id$
 */
public class KeyDerivationFunctionUtils
{
    ...
    /**
     * @return a new instance of the default (best available) key derivation function
     */
    public KeyDerivationFunction newDefaultKDF()
    {
        return new ScryptMemoryHardKeyDerivationFunction();
    }
