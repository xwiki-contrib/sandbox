...
/**
 * Typed flavour of the {@code EntityReferenceSerializer<String>}, which adds the type in front of it in the string
 * serialization (e.g. DOCUMENT://wiki:Space.Page). <br />
